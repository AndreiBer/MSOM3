...
namespace Xvue.Framework.Views.WPF.Controls
{
    ...
    public class ExtraWindowStyles : DependencyObject
    {
        ...
        public const int SweepFrameChanged = 0x0020;
        public const int SweepNoActivate = 0x0010;
        public const int SweepNoMove = 0x0002;
        public const int SweepNoOwnerZOrder = 0x0200;
        public const int SweepNoReposition = 0x0200;
        public const int SweepNoSize = 0x0001;
        public const int SweepNoZOrder = 0x0004;
        ...
        private static void AddWindowStyle(Window window, WindowStyles styleToAdd)
        {
            ...
            NativeMethods.SetWindowPos(wih.Handle, IntPtr.Zero, 0, 0, 0, 0, SweepFrameChanged | SweepNoActivate | SweepNoMove | SweepNoOwnerZOrder | SweepNoReposition | SweepNoSize | SweepNoZOrder);
        }
