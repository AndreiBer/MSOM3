...
namespace Xvue.Framework.Views.WPF.Controls
{
    ...
    /// </summary>
    public class TrimmingTextBox : System.Windows.Controls.TextBox
    {
        // Constructor
        ...
        private void CalcText()
        {
            switch (_placement)
            {
                ...
                default:
                    throw new System.ComponentModel.InvalidEnumArgumentException("Unexpected switch value: " + _placement.ToString());
            }
        }
    }
}
